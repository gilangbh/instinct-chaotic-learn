      ...
      <header className="relative z-20 border-b border-zinc-800/50 backdrop-blur-md bg-[#030303]/80 sticky top-0 shadow-lg shadow-indigo-500/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <Button variant="primary" className="px-6 py-2 shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 transition-shadow" onClick={() => document.getElementById('waitlist')?.scrollIntoView({ behavior: 'smooth' })}>
              Join the Waitlist
            </Button>
          </div>
        </div>
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in slide-in-from-bottom duration-1000 delay-300">
            <Button variant="primary" className="px-10 py-4 text-lg shadow-2xl shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-105 transition-all group" onClick={() => document.getElementById('waitlist')?.scrollIntoView({ behavior: 'smooth' })}>
              Join the Waitlist
            </Button>
          </div>
